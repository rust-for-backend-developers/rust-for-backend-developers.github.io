...
Теперь давайте настроим логирование так, чтобы запись логов производилась в каталог `logs`, а файлы с логами имели префикс `app.log`, и новый лог файл создавался каждый день.
