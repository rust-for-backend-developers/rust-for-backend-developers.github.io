...
Я сталася написать текст простым и понятным, но, вероятно, мне это удалось не везде. Если вы нашли опечатку, неточность, или у вам кажется, что какой-то момент можно было бы перефразировать лучше, то, пожалуйста, напишите об этом:
